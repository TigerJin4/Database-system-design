    ...
    private class BNLJIterator extends JoinIterator {
        ...
        private void fetchNextLeftBlock() {
            ...
            if(leftIterator.hasNext()) {
                ...
                leftRecord = null;
                throw new NoSuchElementException("More more blocks");
            }
        }
        ...
        private void fetchNextRightPage() {
            ...
            } else if(leftRecordIterator == null) {
        ...
        private void fetchNextRecord() {
            ...
            if(leftRecordIterator == null) {
                throw new NoSuchElementException("No more records to fetch");
            }
            nextRecord = null;
            while(!hasNext()) {
                if (leftRecord == null){
                ...
                if (leftRecord != null){
                    if(rightRecord == null){
                        ...
                        if(leftRecord.getValues().get(getLeftColumnIndex()).equals(rightRecord.getValues().get(getRightColumnIndex()))) {
