...
//            System.out.println(record);
            ...
            int partitionNum = ((hash) % partitions.length); //TODO: Weird behavior
...
//        return;
    ...
    private List<Record> buildAndProbe(HashPartition partition) {
        ...
        boolean probeFirst; // True if the probe records come from the left partition \\TODO: Use probeFirst?
...
//            System.out.println(buildJoinValue);
...
//                System.out.println(probeJoinValue);
...
//                    System.out.println(buildRecord);
...
//            System.out.println(joinedRecords);
    ...
    private HashPartition[] createPartitions() {
        ...
        HashPartition[] result = new HashPartition[numBuffers - 1];
